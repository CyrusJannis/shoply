          ...
          child: Center(
            child: SizedBox(
              ...
              child: AdaptivePopupMenuButton.icon(
                icon: PlatformInfo.isIOS26OrHigher() ? 'chevron.left' : Icons.arrow_back,
                    ...
                    return Column(
                      ...
                      children: [
                        ...
                        ...categoryItems.map((item) => ListTile(
                              ...
                              subtitle: Text(
                                '${item.quantity} ${item.unit ?? ''}${item.notes != null && item.notes!.isNotEmpty ? ' • ${item.notes}' : ''}',
                                maxLines: 2,
  ...
  void _showEditItemDialog(BuildContext context, ShoppingItemModel item) {
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        title: Text(AppLocalizations.of(context).editItem, style: AppTextStyles.h2),
