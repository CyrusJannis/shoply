...
class PurchaseTrackingService {
  ...
  Future<void> trackPurchases(List<ShoppingItemModel> items) async {
    try {
      ...
      print('✅ Tracked ${items.length} items for purchase stats');
    } catch (e) {
      print('❌ Error tracking purchases: $e');
      rethrow;
    }
  }
  ...
  Future<void> _trackSingleItem({
    ...
    try {
      ...
      print('❌ Error tracking item "$itemName": $e');
  ...
  Future<List<ItemPurchaseStats>> getFrequentItems({int limit = 20}) async {
    try {
      ...
      print('❌ Error fetching frequent items: $e');
      return [];
    }
  }
  ...
  Future<void> deleteItemStats(String itemName) async {
    try {
      ...
      print('✅ Deleted stats for "$itemName"');
    } catch (e) {
      print('❌ Error deleting item stats: $e');
      rethrow;
    }
  }
  ...
  Future<void> clearAllStats() async {
    try {
      ...
      print('✅ Cleared all purchase stats');
    } catch (e) {
