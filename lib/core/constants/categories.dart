...
class Categories {
  ...
  static const Map<String, IconData> icons = {
    ...
    'Blumen und Pflanzen': Icons.local_florist_rounded,
    'Kühlprodukte': Icons.water_drop_rounded,
    'Tiefkühlprodukte': Icons.ac_unit_rounded,
    'Grundnahrungsmittel': Icons.grain_rounded,
    'Konserven': Icons.inventory_2_rounded,
    'Gewürze': Icons.restaurant_rounded,
    'Würzmittel': Icons.liquor_rounded,
    'Frühstücksprodukte': Icons.free_breakfast_rounded,
    'Süßigkeiten': Icons.cake_rounded,
    'Snacks': Icons.cookie_rounded,
    'Getränke': Icons.local_cafe_rounded,
    'Haushaltswaren': Icons.kitchen_rounded,
    'Reinigungsmittel': Icons.cleaning_services_rounded,
    'Papierwaren': Icons.note_rounded,
    'Drogerie': Icons.medical_services_rounded,
    'Körperpflege': Icons.spa_rounded,
    'Kosmetik': Icons.face_rounded,
    'Hygieneartikel': Icons.clean_hands_rounded,
    'Babyartikel': Icons.child_care_rounded,
    'Tierbedarf': Icons.pets_rounded,
    'Non-Food': Icons.inventory_rounded,
    'Haushaltsgeräte': Icons.electrical_services_rounded,
    'Schreibwaren': Icons.edit_rounded,
    'Textilien': Icons.checkroom_rounded,
    'Spielzeug': Icons.toys_rounded,
    'Saisonartikel': Icons.celebration_rounded,
    'Kassenbereich': Icons.shopping_cart_rounded,
  };
